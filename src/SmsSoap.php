...
class SmsSoap extends BaseSms
{
    ...
    public function SendSMSWithSpeechText($to,$from,$text,$speech)
    {
    ...
    public function SendSMSWithSpeechTextBySchduleDate($to,$from,$text,$speech,$scheduleDate)
    {
    ...
    public function SendBulkSpeechText($title, $body, $receivers, $DateToSend, $repeatCount)
    {
        ...
        $result = $client->SendBulkSpeechText([   
        'username' => $this->username,
        'password' => $this->password,
        'title' => $title,
        'body' => $body,
    ...
    public function SendBulkVoiceSMS($title, $voiceFileId, $receivers, $DateToSend, $repeatCount)
    {
        ...
        $result = $client->SendBulkVoiceSMS([   
        'username' => $this->username,
        'password' => $this->password,
        'title' => $title,
